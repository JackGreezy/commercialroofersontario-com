document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll("form[data-contact-form]").forEach((form) => {
    ...
    if (!status) {
      ...
      status.className = "ontario-form-status";
    ...
    form.addEventListener("submit", async (event) => {
      ...
      try {
        ...
        status.textContent = error?.message || "We could not send your request. Please email repairs@commercialroofersontario.com.";
